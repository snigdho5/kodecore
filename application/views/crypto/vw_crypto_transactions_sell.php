													...
													<tr>
														...
														<td>
															<?php if (!empty($this->session->userdata('userid')) && $this->session->userdata('usr_logged_in') == 1 && $this->session->userdata('usergroup') == 1 && $val['application_status'] == '0') {  ?>
																<button type="button" class="apprv-sell-req" data-id="<?php echo $val['crypto_sellid']; ?>" data-fullname="<?php echo $val['user_name']; ?>" data-amount="<?php echo $val['received_amount']; ?>" data-apprv-type="1"><i class="icofont-tick-mark"></i></button>

																<button type="button" class="apprv-sell-req" data-id="<?php echo $val['crypto_sellid']; ?>" data-fullname="<?php echo $val['user_name']; ?>" data-amount="<?php echo $val['received_amount']; ?>" data-apprv-type="2"><i class="icofont-not-allowed"></i></button>
															<?php }else{
																echo 'N/A';
															} ?>
														</td>
