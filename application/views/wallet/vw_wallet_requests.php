...
<body>
													...
													<tr>
														...
														<td>
															<?php if (!empty($this->session->userdata('userid')) && $this->session->userdata('usr_logged_in') == 1 && $this->session->userdata('usergroup') == 1 && $val['status'] == '0') {  ?>
																<button type="button" class="apprv-wallet-req" data-id="<?php echo $val['redeemid']; ?>" data-fullname="<?php echo $val['user_name']; ?>" data-amount="<?php echo $val['amount']; ?>" data-apprv-type="1"><i class="icofont-tick-mark"></i></button>

																<button type="button" class="apprv-wallet-req" data-id="<?php echo $val['redeemid']; ?>" data-fullname="<?php echo $val['user_name']; ?>" data-amount="<?php echo $val['amount']; ?>" data-apprv-type="2"><i class="icofont-not-allowed"></i></button>
															<?php }else{
																echo 'N/A';
															} ?>
														</td>
	...
	<script src="<?php echo base_url() . 'common/dist/js/app/wallet_req.js?v=' . random_strings(6); ?>"></script>
	<script>
