										...
										<tbody class="textcen">
											...
											?>
													<tr>
														...
														<td><a href="<?php echo base_url() . 'applied-it-projects/'. encode_url($val['projid']); ?>" target="_blank">Show</a></td>
														<td>
															<?php if (!empty($this->session->userdata('userid')) && $this->session->userdata('usr_logged_in') == 1 && $this->session->userdata('usergroup') == 1) {  ?>
																<button type="button" onclick="location.href='<?php echo base_url() . 'edit-project/' . encode_url($val['projid']); ?>'"><i class="icofont-pencil-alt-2"></i></button>
																<button type="button" class="del_proj" data-projid="<?php echo encode_url($val['projid']); ?>" data-fullname="<?php echo $val['title']; ?>"><i class="fas fa-trash-alt"></i></button>
															<?php } ?>
														</td>
													</tr>
												<?php
