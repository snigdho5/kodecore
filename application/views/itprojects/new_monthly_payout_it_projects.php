					...
					<div class="col-12">
						<div class="card">
							...
							<form class="form-horizontal" id="create_payout_form">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'monthly-payout-it-projects'; ?>'"><?php echo $page_title; ?>s List</button></h4>
									...
									<div class="form-group row">
										<label for="proj_id" class="col-sm-3 text-right control-label col-form-label">IT Project</label>
										<div class="col-sm-9">
											<select class="select2 form-control custom-select" id="proj_id" name="proj_id">
												<option value="">Select</option>
