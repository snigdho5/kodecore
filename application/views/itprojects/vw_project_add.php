				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							?>
							<form class="form-horizontal" id="create_proj_form">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'it-projects'; ?>'"><?php echo $page_title; ?>s List</button></h4>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control num-upto2" id="duration" name="duration" placeholder="Duration..">
										</div>
									</div>
								...
								<div class="border-top">
									<div class="card-body">
										<button type="submit" id="proj_btn_submit" class="btn btn-primary proj_btn_submit">Submit</button>
									</div>
								</div>
							</form>
						</div>
