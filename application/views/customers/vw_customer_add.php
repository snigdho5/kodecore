				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							?>
							<form class="form-horizontal" id="create_customer_form" autocomplete="off">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'customers'; ?>'"><?php echo $page_title; ?>s List</button></h4>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<label id="chk_phone" style="display: none;" autocomplete="off"></label>
										</div>
									</div>
								...
								<div class="border-top">
									<div class="card-body">
										<button type="submit" id="customer_btn_submit" class="btn btn-primary customer_btn_submit">Submit</button>
									</div>
								</div>
							</form>
						</div>
